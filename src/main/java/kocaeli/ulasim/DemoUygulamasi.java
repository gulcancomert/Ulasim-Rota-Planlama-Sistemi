    ...
    private void calculateNavigation(String yolcuTipi) {
        try {
            ...
            SehirVerisi sehirVerisi = JSONVeriYukleyici.verileriYukle(
                     "C:\\Users\\HP\\OneDrive\\Masaüstü\\Maven2\\demo\\src\\main\\java\\kocaeli\\ulasim\\jsonveri.txt"
            );
            if (sehirVerisi == null) {
    ...
    private String createMapHTML() {
        ...
        String iconDefinitions =
                "// startMarker (red), destMarker (blue)\n" +
                        ...
                        "  iconUrl: 'file:///C:/Users/HP/OneDrive/Masaüstü/Maven2/demo/src/main/java/kocaeli/ulasim/durak.jpg',\n" +
                        "  iconSize: [32, 32],\n" +
                        "  iconAnchor: [16, 32],\n" +
                        "  popupAnchor: [0, -32]\n" +
                        "});\n" +
